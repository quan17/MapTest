...
/**
 * Created by chand_000 on 2015/6/23.
 */
...
public class GetDirection {
    ...
    public final static String APIKey = "AIzaSyCNWAA6hJ7S6tLl6lBdO4thCSNwFqWhF1U";
//    server API key
    public GetDirection() {
    }
    ...
    public Document getDocument(LatLng start, LatLng end, String mode) {
        String url = "https://maps.googleapis.com/maps/api/directions/xml?"
                ...
                + "&sensor=false&units=metric&mode=driving&avoid=highways&key="+APIKey;
//        &key="+APIKey
